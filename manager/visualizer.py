...
URL = os.getenv("MATCH_SERVER_URL") or "http://localhost:3000"
TOKEN = os.getenv("MATCH_SERVER_TOKEN") or "default_token"
...
stop_at = start_at + datetime.timedelta(seconds=MATCH_TIME)
